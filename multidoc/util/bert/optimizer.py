...
def get_bert_optimizer(model,lr,num_data,batch_size,epoch_num,gradient_accumulation_steps):
    t_total = math.ceil((num_data / gradient_accumulation_steps / batch_size)) * epoch_num
